...
public class UserCacheCategoryServiceImpl implements CategoryService {
    ...
    // 부모 카테고리별 상품 조회
    @Override
    @Cacheable(value = "categories", key = "'productCategory-' + #parentCategoryId")
    ...
    @Override
    @Cacheable(value = "brands" , key = "'byCategory-' + #brandCategoryId")
    ...
    @Override
    @Cacheable(value = "brands", key = "'byLetter-' + #brandFirstLetter")
